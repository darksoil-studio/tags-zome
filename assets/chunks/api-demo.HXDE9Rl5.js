import{f as ce,j as ue,t as ye,k as $e,D as Ie,A as pe,l as we,p as xe,q as je,v as Fe,x,u as Se,o as ae,r as Ne,T as Re,n as S,s as Pe,M as He,m as Ue,h as ze,e as We,g as Xe,a as _e,b as qe,i as de,d as Ve}from"./api-viewer-tabs.CX3g7Nrf.js";import{_ as N}from"./tslib.es6.kHcLnhpD.js";const Y=[],Ze=(n,e)=>{Y[n]=e},I=Object.freeze({HOST:"host",KNOB:"knob",SLOT:"slot",PREFIX:"prefix",SUFFIX:"suffix",WRAPPER:"wrapper"}),B=n=>n instanceof HTMLTemplateElement,fe=(n,e)=>t=>{const{element:s,target:r}=t.dataset;return s===n&&r===e},J=n=>B(n)?n.content.firstElementChild:null,W=(n,e,t)=>Y[n].find(fe(e,t)),Ge=(n,e,t)=>Y[n].filter(fe(e,t)),re=(n,e,t)=>Y[n].some(fe(e,t));/**
 * @license
